window.MOVENSO_PACKS = [
  {
    ...
    title: "Judo",
    discipline: "Judo",
    summary: "Une base structurée du judo suivant la nomenclature Kodokan, avec une navigation relationnelle bêta (préparations, enchaînements, contres, katas, fondamentaux) et des liens de démonstration lorsqu'ils existent.",
    type: "beta",
    statusLabel: "Bêta",
    version: "0.2.0",
    updatedAt: "26 juillet 2026",
    itemCount: "111 techniques · 825 liens",
    language: "Français",
    maintainer: "Movenso",
    license: "CC BY-NC-SA 4.0",
    features: ["Nomenclature", "Navigation relationnelle", "Liens vidéo"],
