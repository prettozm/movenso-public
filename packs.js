window.MOVENSO_PACKS = [
  {
    ...
    title: "Judo",
    discipline: "Judo",
    summary: "Une base structurée du judo suivant la nomenclature Kodokan, avec une navigation relationnelle bêta : chaque lien (enchaînements, contres, variantes, « à ne pas confondre », katas) est expliqué par une courte raison, et les techniques interdites en compétition IJF sont signalées.",
    type: "beta",
    statusLabel: "Bêta",
    version: "0.4.0",
    updatedAt: "27 juillet 2026",
    itemCount: "111 techniques · 275 liens expliqués",
    language: "Français",
    maintainer: "Movenso",
